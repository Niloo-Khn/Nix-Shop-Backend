...
const pending:Order={id:"order-1",accountId:"account-1",items:[{productId:"bed",quantity:2,unitPrice:40}],subtotal:80,discount:0,amount:80,currency:"USD",status:"pending",shippingAddress:"1 Pet Street",createdAt:new Date().toISOString()};

...
const pending:Order={id:"order-1",items:[{productId:"bed",quantity:2,unitPrice:40}],subtotal:80,discount:0,amount:80,currency:"USD",status:"pending",createdAt:new Date(0).toISOString()};
